...
//!
//! It lives in `cairn-core` and not `cairn-client` for the reason ADR-0020
//! settled: `cairn-client` (tokio + rusqlite) and `cairn-ffi-wasm` are
...
use cairn_domain::{Lsn, Operation};
...
impl PullCursor {
    ...
    /// pages the way it does. `cairn doctor` checks the deployed function
