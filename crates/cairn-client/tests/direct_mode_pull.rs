//! Direct mode end to end against a fake PostgREST — no Cairn server anywhere
...
//! the SQL nor `cairn-core` can demonstrate alone.

use std::sync::{Arc, Mutex};

use axum::{extract::State, Json, Router};
use cairn_client::{PostgrestError, PostgrestSource, SqliteStorage};
use cairn_core::{ApplyEngine, Horizon, PendingWrite, PullCursor, Storage, WriteOp};
