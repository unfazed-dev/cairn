...
pub use ports::{
    ...
    SessionStore, SnapshotError, SnapshotSource, StoreRejection, SyncAuth, WriteBack,
    WriteBackError,
};
...
pub use cairn_domain::{Lsn, Predicate, Principal, ReplicationEvent, SessionId, SyncSession};
