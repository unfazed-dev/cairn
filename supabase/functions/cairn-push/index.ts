...
//
// `cairn.wake_absent_devices()` (generated by `cairn link --mode direct
...
// Secrets: CAIRN_PUSH_SECRET  (must equal cairn.push_config.secret)
...
// anyone who learns the URL. `cairn doctor --mode direct` fails if the secret
// is unset.
//
...
Deno.serve(async (req: Request): Promise<Response> => {
  const secret = Deno.env.get("CAIRN_PUSH_SECRET") ?? Deno.env.get(LEGACY_SECRET);
