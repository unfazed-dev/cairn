// The browser-Worker leg of `cairn_core::conformance` (direct-mode plan, step 8).
//
// The same four cases run three times, once per Storage implementation:
//   - `InMemoryStorage`  — cairn-core's own unit tests
//   - `SqliteStorage`    — crates/cairn-client/tests/conformance_sqlite.rs
