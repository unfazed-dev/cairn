...
const cairnConfig = CairnConfig(url: 'ws://127.0.0.1:8800/sync');

const cairnSchema = CairnSchema(
  tables: [
    CairnTable(
      name: 'tasks',
      primaryKey: ['id'],
...
class Task {
  ...
  factory Task.fromRow(Map<String, dynamic> r) => Task(
    ...
    completed: r['completed'] is int
        ? r['completed']
        : int.tryParse('${r['completed']}'),
...
class Availability {
  ...
  factory Availability.fromRow(Map<String, dynamic> r) => Availability(
    ...
    weekday: r['weekday'] is int
        ? r['weekday']
        : int.tryParse('${r['weekday']}'),
    startMin: r['start_min'] is int
        ? r['start_min']
        : int.tryParse('${r['start_min']}'),
    endMin: r['end_min'] is int
        ? r['end_min']
        : int.tryParse('${r['end_min']}'),
  );
...
class Appointment {
  ...
  factory Appointment.fromRow(Map<String, dynamic> r) => Appointment(
    ...
    durationMin: r['duration_min'] is int
        ? r['duration_min']
        : int.tryParse('${r['duration_min']}'),
...
class Invoice {
  ...
  factory Invoice.fromRow(Map<String, dynamic> r) => Invoice(
    ...
    clientId: r['client_id']?.toString(),
    amountCents: r['amount_cents'] is int
        ? r['amount_cents']
        : int.tryParse('${r['amount_cents']}'),
    status: r['status']?.toString(),
