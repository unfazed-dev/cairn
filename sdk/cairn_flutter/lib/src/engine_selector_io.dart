...
/// Create the direct-mode [CairnEngine] ([DirectCairnEngine]): device →
/// Supabase, no `cairn-server` process (ADR-0045). Initializes the Rust runtime
/// once, exactly like [createCairnEngine].
///
...
Future<CairnEngine> createDirectCairnEngine({
  ...
  return DirectCairnEngine.connect(
