...
// Rust type: RustOpaqueMoi<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<CairnDirectHandle>>
abstract class CairnDirectHandle implements RustOpaqueInterface {
  ...
  static CairnDirectHandle connect({
    required String supabaseUrl,
    required String anonKey,
    String? token,
    required String dbPath,
  }) => RustLib.instance.api.crateApiDirectCairnDirectHandleConnect(
  ...
  Stream<CairnConnectionState> start({required String scope});
