...
#   1. Operator creates a `cairn-sync/homebrew-cairn` tap repo
#      (https://github.com/cairn-sync/homebrew-cairn), containing a
...
#   3. Users then: `brew tap cairn-sync/cairn && brew install cairn`.
#
...
class Cairn < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/cairn-sync/cairn/releases/download/v0.1.0/cairn-aarch64-apple-darwin.tar.gz"
      sha256 "REPLACE_WITH_aarch64-apple-darwin_TAR_GZ_SHA256"
    end
    on_intel do
      url "https://github.com/cairn-sync/cairn/releases/download/v0.1.0/cairn-x86_64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/cairn-sync/cairn/releases/download/v0.1.0/cairn-x86_64-unknown-linux-gnu.tar.gz"
