...
Give Cairn a first-class answer to the sync-rules / stream-editor pattern used by comparable sync products: a
...
1. **Context** — cairn has server-enforced predicates (ADR-0011) and a dynamic
   ...
   syncs*. Comparable sync products have declarative sync rules; cairn has env vars.
