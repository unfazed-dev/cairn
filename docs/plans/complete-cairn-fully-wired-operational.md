...
7. **Strategy drift (July 2026 market check, sourced):**
   - A comparable engine shipped **dynamic, on-demand sync to GA in May 2026**, retiring its old fixed-partition sync-rules model — Cairn's "static buckets" attack line is gone.
